...
def function1():
    ...
    x =np.arange(1,13).reshape(6,2) #wrtie your code here
...
def function2():
    ...
    x =np.arange(10,37).reshape(3,3,3).astype(float) #wrtie your code here
...
def function5():
    ...
    z =np.zeros((4,5)) #wrtie your code he
...
def function6():
    ...
    arr[5]=10; arr[8]=20 #wrtie your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    arr1=np.repeat(arr,3) #write your code here
    arr2=np.tile(arr,3)
...
def function14():
    ...
    ans = numpy.split(arr,[2,4,6]) #write your code here 
...
def function18():
    ...
    x =np.intersect1d(a,s).size  # Write you code Here
    return x
